...
CROP_MODE = False
MIN_CROPS= 2
MAX_CROPS= 9 # max:9; If your GPU memory is small, it is recommended to set it to 6.
MAX_CONCURRENCY = 200 # If you have limited GPU memory, lower the concurrency count.
